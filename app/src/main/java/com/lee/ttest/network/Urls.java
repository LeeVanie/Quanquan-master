package com.lee.ttest.network;

/**
 * Created by 365rili on 16/5/4.
 */
public class Urls {
    public final static String GET_IMAGE_WELCOME = "http://img.blog.csdn" +
            ".net/20161223204711048?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvbGFveWFuZzM2MA ==/font /5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast";
